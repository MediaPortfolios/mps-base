...
class Meta_Image {
	...
	public function __construct() {
		...
		add_action( 'mpb_meta_image_tag', [ $this, 'image' ] );
	...
	public function image() {
		...
		if ( mpb_acf_options() ) {
			...
			$blog_image    = get_field( 'mpb_meta_blog_image', 'option' );
			$default_image = get_field( 'mpb_meta_default_image', 'option' );
