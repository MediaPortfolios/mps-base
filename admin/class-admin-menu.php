...
class Admin_Menu {
    ...
    public function __construct() {
        ...
        if ( mpb_acf_options() ) {
            ...
            $options = get_field( 'mpb_admin_hide_links', 'option' );
        ...
        // Get links option.
        if ( mpb_acf_options() ) {
            $links = get_field( 'mpb_links_manager', 'option' );
        } else {
            $links = get_option( 'mpb_hide_links' );
        }
    ...
    public function hide() {
        ...
        if ( mpb_acf_options() ) {
            ...
            // Get options.
            $appearance = get_option( 'mpb_hide_appearance' );
            $plugins    = get_option( 'mpb_hide_plugins' );
            $users      = get_option( 'mpb_hide_users' );
            $tools      = get_option( 'mpb_hide_tools' );
    ...
    public function menus_widgets() {
        ...
        if ( mpb_acf_options() ) {
            ...
            $menus_link   = get_field( 'mpb_menus_position', 'option' );
            $widgets_link = get_field( 'mpb_widgets_position', 'option' );
        ...
        // If ACF is not active.
            ...
            $menus_link   = get_option( 'mpb_menus_position' );
            $widgets_link = get_option( 'mpb_widgets_position' );
