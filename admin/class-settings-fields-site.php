...
class Settings_Fields_Site {
	...
	private function dependencies() {
		...
		require MPB_PATH . 'admin/class-settings-fields-site-dashboard.php';

		// Settings for the Admin Menu tab.
		require MPB_PATH . 'admin/class-settings-fields-site-admin-menu.php';

		// Settings for the Admin Menu tab.
		require MPB_PATH . 'admin/class-settings-fields-site-admin-pages.php';

		// Settings for the Admin Menu tab.
		require MPB_PATH . 'admin/class-settings-fields-site-users.php';

		// Callbacks for the Meta/SEO tab.
		require MPB_PATH . 'admin/class-settings-fields-site-meta-seo.php';
	...
	public function site_settings() {
		...
		$defaults = [
			...
			'settings_link_label' => __( 'Site Settings', 'mps-text' ),
		...
		return apply_filters ( 'mpb_site_settings', $defaults );
 ...
 */
function mpb_settings_fields_site() {
