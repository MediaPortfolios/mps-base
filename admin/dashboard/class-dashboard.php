...
class Dashboard {
	...
	private function dependencies() {
        ...
        require MPB_PATH . 'admin/dashboard/class-dashboard-widget.php';

        // Get the welcome panel class.
        require MPB_PATH . 'admin/dashboard/class-welcome.php';
    ...
    public function metaboxes() {
        ...
        if ( mpb_acf_options() ) {
            ...
            $hide = get_field( 'mpb_dashboard_hide_widgets', 'option' );
        ...
        // If Advanced Custom Fields is not active.
            ...
            // Get options.
            $welcome    = get_option( 'mpb_hide_welcome' );
            $gutenberg  = get_option( 'mpb_hide_try_gutenberg' );
            $wp_news    = get_option( 'mpb_hide_wp_news' );
            $quickpress = get_option( 'mpb_hide_quickpress' );
            $at_glance  = get_option( 'mpb_hide_at_glance' );
            $activity   = get_option( 'mpb_hide_activity' );
    ...
    public function add_help() {
		...
		$screen->add_help_tab( [
			...
			'title'    => __( 'Welcome Panel', 'mps-text' ),
			'content'  => null,
		...
		$screen->add_help_tab( [
			...
			'title'    => __( 'Dashboard Widgets', 'mps-text' ),
			'content'  => null,
	...
	public function help_welcome_panel() {
        ...
        include_once MPB_PATH . 'partials/help/help-welcome-panel.php';
	...
	public function help_dashboard_widgets() {
        ...
        include_once MPB_PATH . 'partials/help/help-dashboard-widgets.php';
    ...
    public function help_dashboard_sidebar() {
        ...
        $html  = sprintf(
            '<h4>%1s %2s</h4>',
            __( 'Custom Dashboard for', 'mps-text' ),
             get_bloginfo( 'name' )
        );
	...
	public function styles() {
        ...
        if ( $screen->id == 'dashboard' ) {
            wp_enqueue_style( MPB_ADMIN_SLUG . '-dashboard', MPB_URL .  'admin/dashboard/assets/css/dashboard.min.css', [], null, 'screen' );
        }
